...
urlpatterns=[
    ...
    path("category/<int:pk>/create/",BookCategoryRetrieveView.as_view(),name="category-create"),
    path("category/<int:pk>/update/",BookCategoryRetrieveView.as_view(),name="category-update"),
    path("category/<int:pk>/delete/",BookCategoryRetrieveView.as_view(),name="category-delete"),
